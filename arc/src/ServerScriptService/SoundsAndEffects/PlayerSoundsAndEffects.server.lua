...
local ps = require(workspace.Modules.PlayerGlob.PlayerSounds)
...
players.PlayerAdded:Connect(function(player)
	player.CharacterAdded:Connect(function(character)
		...
		local slamming = Values:FetchLocal(player, "slamming");
		local sliding = Values:FetchLocal(player, "sliding");
		local dashing = Values:FetchLocal(player, "dashing");
